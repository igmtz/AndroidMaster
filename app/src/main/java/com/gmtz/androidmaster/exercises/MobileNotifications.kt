package com.gmtz.androidmaster.exercises

/**
 * Typically, your phone provides you with a summary of notifications.
 *
 * In the initial code provided in the following code snippet, write a program that prints
 * the summary message based on the number of notifications that you received. The message
 * should include:
 *
